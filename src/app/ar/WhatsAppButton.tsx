...
const WHATSAPP_PHONE = '34643796718'
...
export default function WhatsAppButton({ pizzaName }: Props) {
  const message = encodeURIComponent(
    `Hola, me interesa pedir la pizza "${pizzaName}" que vi en el menú AR 🍕`
  )
  const href = `https://wa.me/${WHATSAPP_PHONE}?text=${message}`
